...
NDefines.NMilitary.ARMY_FUEL_COST_MULT = 0.5
NDefines.NAir.FUEL_COST_MULT = 0.7
...
NDefines.NAir.ANTI_AIR_MAXIMUM_DAMAGE_REDUCTION_FACTOR = 0.5
...
NDefines.NMilitary.LAND_AIR_COMBAT_STR_DAMAGE_MODIFIER = 0.0065
NDefines.NMilitary.LAND_AIR_COMBAT_ORG_DAMAGE_MODIFIER = 0.0045
